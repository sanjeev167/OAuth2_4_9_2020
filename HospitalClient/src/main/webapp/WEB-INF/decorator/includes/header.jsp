...
<header class="main-header">
	...
	<a href="/" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
		<span class="logo-mini"><b>H</b>PT</span> <!-- logo for regular state and mobile devices -->
		<span class="logo-lg"><b>PON [ Hospital ]</b></span>
	</a>
	...
	<nav class="navbar navbar-static-top" role="navigation">
		...
		<div class="collapse navbar-collapse pull-left" id="navbar-collapse">
            ...
            <li><a href="/pvt/dept/">Hospital Department</a></li> 	
					...
					<ul class="dropdown-menu">
						...
						<li class="user-footer">
							...
							<div class="pull-right">
								<a href="#" id="logoutLinkId" class="btn btn-default btn-flat">Sign
									out</a>
							</div>
						</li>
					</ul>
