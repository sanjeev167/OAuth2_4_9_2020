...
<body class="hold-transition skin-yellow  layout-top-nav ">
	...
	<!-- SlimScroll -->
	<script
		src="${contextPath}/resources/assets/bower_components/jquery-slimscroll/jquery.slimscroll.min.js"
		type="text/javascript"></script>
	<!-- FastClick -->
	<script
		src="${contextPath}/resources/assets/bower_components/fastclick/lib/fastclick.js"
		type="text/javascript"></script>
	<!-- AdminLTE App -->
	<script
		src="${contextPath}/resources/assets/dist/js/adminlte.min.js"
		type="text/javascript"></script>
	<!-- page script -->
