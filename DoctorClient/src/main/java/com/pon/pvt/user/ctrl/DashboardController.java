...
public class DashboardController {
	...
	public String dashboard(Model model, HttpServletRequest request, HttpServletResponse response) {
		...
		System.out.println("DashboardController [Doctor]: --  SSO has authenticated this user");
		System.out.println("ClientRegistrationId Type = "+oauthToken.getAuthorizedClientRegistrationId());
